#!/usr/bin/env python
# -*- coding: utf-8 -*-
#Created by Chukwunyere Igbokwe on December 20, 2016 by 1:06 PM
...
def process_image(img):
    ...
    vertices = np.array([[(105, .888 * imshape[0]), (.333 * imshape[1], .708 * imshape[0]),
                          (.528 * imshape[1], .597 * imshape[0]), (imshape[1], .805 * imshape[0])]], dtype=np.int32)
